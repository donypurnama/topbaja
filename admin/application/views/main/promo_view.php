    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Daftar Promo</h4>
                        <hr>
                        <a class="btn btn-with-icon btn-primary btn-fill btn-wd btn-header" href="promo/add"><i class="ti-file"></i>Tambah Promo Baru</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="td-article col-md-6">
                                        <div class="row">
                                            <div class="col-md-4 pull-left"><?php echo $result["promo_cover"]; ?></div>
                                            <div class="col-md-8 pull-right">
                                                <h5><?php echo $result["promo_title"];?></h5>
                                                <p class="article-text text-ellipsis-row-5"><?php echo strip_tags(str_replace("\n", '', preg_replace("/<img[^>]+\>/i", "", $result["promo_content"])));?></small>
                                            </div>
                                        </div>
                                        <p class="text-date">Dibuat pada <?php echo $result["promo_created_time"];?></p>
                                    </td>
                                    <td>
                                      <?php
                                        echo $result["promo_status"];
                                      ?></td>
                                    <td class="td-buttons">
                                        <a href="promo/edit/<?php echo $result['promo_url'];?>" class="btn btn-sm btn-info btn-fill"><i class="ti-pencil-alt2"></i>Ubah</a>
                                        <a href="#" data-href="promo/delete/<?php echo $result['promo_id'];?>" data-target="#confirm-delete" class="btn btn-sm btn-danger btn-fill"><i class="ti-eraser"></i>Hapus</a>
                                    </td>
                                </tr>
                                <?php
                                    }
