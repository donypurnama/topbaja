    ...
    <div class="container">
        ...
        <div class="col-sm-9" id="blog-listing">
            ...
            <div class="box">
                ...
                <p class="text-muted" style="letter-spacing:0.5px;">Tulisan artikel terbaru dan halaman penting untuk pengunjung</p>

            </div>

            <?php foreach($blogs as $key => $value ){?>
            <div class="post">
                <h2><a href="blog/<?php echo $value['article_url']; ?>"><?php echo $value["article_title"]; ?></a></h2>
                <hr>
                <p class="date-comments">
                    <a href="blog/<?php echo $value['article_url']; ?>"><i class="fa fa-calendar-o"></i> <?php echo $value["article_created_time"]; ?></a>
                </p>
                <?php
                if ($value["article_image"]) {
                ?>
                <div class="image">
                    <a href="blog/<?php echo $value['article_url']; ?>">
                ...
                <p class="read-more"><a href="blog/<?php echo $value['article_url']; ?>" class="btn btn-primary">Continue reading</a>
                </p>
            </div>
            <?php } ?>
