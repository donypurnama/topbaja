    ...
    <div class="container">
      <div class="col-md-12">
        <ul class="breadcrumb">
          ...
          <li><?php echo $brands['brand_name'];?></li>
        </ul>
      </div>
            ...
            <tbody>
              <tr>
                <td style="padding-right: 20px;">
                  <img class="img-responsive" style="height:80px;" src="file_assets/brands/<?php echo $brands["brand_image"];?>" />
                </td>
                <td>
                  <h3><?php echo $brands['brand_name'];?></h3>
                  <p class="hidden-xs"><?php echo $brands['brand_description'];?></p>
                </td>
              </tr>
            </tbody>
          </table>
